Monitoring a diagnostika tepelného čerpadla (Python scripts)
Tento repozitár obsahuje sadu Python skriptov určených pre inteligentné riadenie a pokročilú analytiku tepelného čerpadla v systéme Home Assistant (cez integráciu PyScript).
